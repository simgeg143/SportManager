...
The -Duser.home argument redirects the JavaFX native DLL extraction cache to an ASCII-only path, preventing a runtime failure on Windows systems with non-ASCII usernames.
